                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" name="JudBuk" id="" class="form-control" placeholder=""
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" name="Tulis" id="" class="form-control" placeholder=""
                                       aria-describedby="helpId">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" name="Terbit" id="" class="form-control" placeholder=""
                                       aria-describedby="helpId">
                            </div>
                                    ...
                                    <label class="col-md-6 form-check">
                                        <div class="row">
                                            <div class="form-check col-md-6">
                                                <input class="form-check-input" type="radio" name="BHS" id="gridRadios2"
                                                       value="Indonesia">
                                            ...
                                            <div class="form-check col-md-6">
                                                <input class="form-check-input" type="radio" name="BHS" id="gridRadios3"
                                                       value="Lainnya">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="Tag[]" id=""
                                                   value="Pemograman" checked>Pemograman


                                            <input type="checkbox" class="form-check-input" name="Tag[]" id=""
                                                   value="Website" checked>Website
                                            ...
                                            <input type="checkbox" class="form-check-input" name="Tag[]" id=""
                                                   value="MVC" checked>MVC


                                            <input type="checkbox" class="form-check-input" name="Tag[]" id=""
                                                   value="Kalkulus" checked>Kalkulus
                                            <input type="checkbox" class="form-check-input" name="Tag[]" id=""
                                                   value="Lainnya" checked>Lainnya
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="custom-file">
                                            <input type="file" name="inputImg" class="custom-file-input"
                                                   id="customFile">
