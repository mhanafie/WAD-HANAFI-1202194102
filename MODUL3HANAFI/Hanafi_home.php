...
<section id="home">
    ...
    <div class="container">
        ...
        if (mysqli_num_rows($querysql) == 0) { ?>
            <center>
                <h1 class="h-100" style="margin-top: 200px;">Belum Ada Buku
                    <hr>
                </h1>
            </center>
            ...
            <?php while ($row = mysqli_fetch_array($querysql)) { ?>
                <div class="col-md-4">
                    <div class="card card-home">
                        <img class="card-img-top image-awal" src="<?php echo $row['gambar'] ?>"
                        ...
                        <div class="card-footer bg-transparent ">
                            <a href="Hanafi_detail.php?id_buku=<?php echo $row['id_buku'] ?>">
                                ...
                                <p style="text-align: end;">
                                    <button type="button" class="btn btn-secondary">Lihat Detail</button>
                                </p>
                            </a>
                        </div>
                    </div>
