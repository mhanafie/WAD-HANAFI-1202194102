...
<!--                                         <p><i class="fa fax fa-map-marker"></i><?php echo $row['tempat'] ?></p>
                        ...
                        <form action="Hanafi_detail.php?id_buku=<?php echo $row['id_buku'] ?>" method="post">
                            ...
                            <div class="card-footer bg-transparent">
                                ...
                                <p style="text-align: center;">
                                    ...
                                    <button type="submit" value="<?php echo $row['id_buku'] ?>" name="APUS" class="btn btn-danger">Hapus
                ...
                <!-- Modal -->
                <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container mx-auto my-5">
                                    <form action="Hanafi_detail.php?id_buku=<?php echo $row['id_buku'] ?>" method="post" enctype="multipart/form-data">
                                        <div class="row">
              ...
              <input type="hidden" name="DIBOK" value=<?php echo $row['id_buku'] ?>>
              <div class="form-group">
                <h6>Judul Buku</h6>
                <input required type="text" name="JUDBUK" id="" class="form-control" value="<?php echo $row['judul_buku'] ?>" placeholder="" aria-describedby="helpId">
              </div>

              <div class="form-group">
                <h6 style="margin-top:5px;"> Penulis</h6>
                <input required type="text" name="TULIS" id="" class="form-control" placeholder="" value="<?php echo $row['penulis_buku'] ?>" aria-describedby="helpId">
              </div>
              ...
              <div class="form-group">
                <h6 style="margin-top:5px;">Deskripsi</h6>
                 <textarea required class="form-control" name="DEC" id="" rows="3" value=""><?php echo $row['deskripsi'] ?></textarea>
              </div>
                                                ...
                                                $kat7 = false;
                                                    ...
                                                    if ($isBenefitEmpty) {
                                                        ...
                                                        if (in_array("Pemograman", $arrayBenefit)) {
                                                            ...
                                                            if (in_array("Website", $arrayBenefit)) {                                                               $kat2 = true;
                                                            }
                                                                ...
                                                                <div class="row col-md-10">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <label class="form-check-label">
                                                                            <input <?php echo ($kat1) ? 'checked' : ''; ?> type="checkbox" class=

                                                                            "form-check-input" name="Tag[]" id="" value="Pemograman">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <label class="form-check-label">
                                                                            <input <?php echo ($kat2) ? 'checked' : ''; ?> type="checkbox" class="form-check-input" name="Tag[]" id="" value="Website">
                                                                            Website
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <label class="form-check-label">
                                                                            <input <?php echo ($kat3) ? 'checked' : ''; ?> type="checkbox" class="form-check-input" name="Tag[]" id="" value="Java">
                                                                            Java
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <label class="form-check-label">
                                                                            <input <?php echo ($kat4) ? 'checked' : ''; ?> type="checkbox" class="form-check-input" name="Tag[]" id="" value="OOP">
                                                                            OOP
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <label class="form-check-label">
                                                                            <input <?php echo ($kat5) ? 'checked' : ''; ?> type="checkbox" class="form-check-input" name="Tag[]" id="" value="MVC">
                                                                            MVC
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <label class="form-check-label">
                                                                            <input <?php echo ($kat6) ? 'checked' : ''; ?> type="checkbox" class="form-check-input" name="Tag[]" id="" value="Kalkulus">
                                                                            Kalkulus
                                                                        </label>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label class="form-check-label">
                                                                            <input <?php echo ($kat7) ? 'checked' : ''; ?> type="checkbox" class="form-check-input" name="Tag[]" id="" value="Lainnya">
                                                                            Lainnya
                                                                        </label>
                                                                    </div>
