    ...
    <div class="container-fluid">
        ...
        <div class="nav navbar-right">
            ...
            <a class="nav-link text-light" href="#">
                <button type="button" class="btn btn-primary"><span>REGISTER</span></button>
            </a>
        ...
        <div class="card-body">
            ...
            <form method="post" action="">
                ...
                <div class="form-group ml-3">
                    ...
                    <input type="number" class="form-control" name="no_hp" style="width:80%"
                ...
                <div class="form-group ml-3">
                    ...
                    <input type="password" class="form-control" name="konfirmasi_password" style="width:80%"
