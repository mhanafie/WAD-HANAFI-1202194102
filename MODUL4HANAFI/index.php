                ...
                <div class="card-body pt-0 px-3">
                    <div class="row border rounded">
                        <div class="col card border-0 px-0">
                            <img class="card-img-top" src="assets/img/Turkey.jpg" alt="Card image cap" style="height:199.5px;height:199.5px">
                        ...
                        <div class="col card border-top-0 border-bottom-0 px-0">
                            <img class="card-img-top" src="assets/img/spain.jpg" alt="Card image cap" style="height:199.5px;height:199.5px">
                            <div class="card-body px-3">
                        ...
                        <div class="col card border-0 px-0">
                            <img class="card-img-top" src="assets/img/france.jpg" alt="Card image cap" style="height:199.5px;height:199.5px">
                            <div class="card-body px-3">
                    ...
                    <div class="row border rounded" align="center">
                        <div class="col card border-0">
                            <button type="button" class="btn btn-primary btn-sm my-3" data-target="#modal1" data-toggle="modal" style="width:100%">Pesan Tiket</button>
                        </div>
                        <div class="col card border-top-0 border-bottom-0">
                            <button type="button" class="btn btn-primary btn-sm my-3" data-target="#modal2" data-toggle="modal"style="width:100%">Pesan Tiket</button>
                        </div>
                        <div class="col card border-0">
                            <button type="button" class="btn btn-primary btn-sm my-3" data-target="#modal3" data-toggle="modal" style="width:100%">Pesan Tiket</button>
                        </div>
                    </div>
                </div>
            </form>
